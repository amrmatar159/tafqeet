...
function tafqeet(NumIn: any = 0, { Feminine, Comma, SplitHund, Miah, Billions, TextToFollow, AG, Subject, Legal }: any = {}) {
    if (NumIn == 0) return "صفر";                          // if 0 or "0" then "zero"
    let Triplet: any, Scale: any, ScalePos, ScalePlural: any, TableUnits: any, Table11_19: any, NumberInWords: any = "", IsLastEffTriplet = false, Num_99: any;
    ...
    NumIn = "" + NumIn.replace(/[٠-٩]/g, (d: any) => "٠١٢٣٤٥٦٧٨٩".indexOf(d)); // Convert Arabic-Indic Numbers to Arabic if any
